...
task :setup do
  sh({ "BUNDLE_PATH__SYSTEM" => "true" }, "ruby", "-I", "lib", "bundler/spec/support/bundle.rb", "install", "--gemfile=dev_gems.rb")
end

desc "Update Rubygems dev environment"
task :update do |_, args|
  sh({ "BUNDLE_PATH__SYSTEM" => "true" }, "ruby", "-I", "lib", "bundler/spec/support/bundle.rb", "update", *args, "--gemfile=dev_gems.rb")
end

desc "Update the locked bundler version in dev environment"
task :update_locked_bundler do |_, args|
  sh({ "BUNDLE_PATH__SYSTEM" => "true" }, "ruby", "bundler/spec/support/bundle.rb", "update", "--bundler", "--gemfile=dev_gems.rb")
  sh({ "BUNDLE_PATH__SYSTEM" => "true" }, "ruby", "bundler/spec/support/bundle.rb", "update", "--bundler", "--gemfile=bundler/tool/bundler/test_gems.rb")
  sh({ "BUNDLE_PATH__SYSTEM" => "true" }, "ruby", "bundler/spec/support/bundle.rb", "update", "--bundler", "--gemfile=bundler/tool/bundler/rubocop_gems.rb")
  sh({ "BUNDLE_PATH__SYSTEM" => "true" }, "ruby", "bundler/spec/support/bundle.rb", "update", "--bundler", "--gemfile=bundler/tool/bundler/rubocop23_gems.rb")
  sh({ "BUNDLE_PATH__SYSTEM" => "true" }, "ruby", "bundler/spec/support/bundle.rb", "update", "--bundler", "--gemfile=bundler/tool/bundler/standard_gems.rb")
  sh({ "BUNDLE_PATH__SYSTEM" => "true" }, "ruby", "bundler/spec/support/bundle.rb", "update", "--bundler", "--gemfile=bundler/tool/bundler/standard23_gems.rb")
end
